...
const Pricing = () => {
  return (
    ...
    <div app__pricing-title_2><h4>Our Workplace Gallery features modern office, team collaboration, and fun culture.
Attracts talents and showcases company's work atmosphere.</h4></div> 
        ...
        <div className='app__pricing-card'>
            ...
            <p>Beginners</p>
            <h3>₹850<small> /month</small></h3>
            <h5>Free hand</h5>
            <h5>Gym Fitness</h5>
            <h5>Weight Loss</h5>
            <h5>Personal Trainer</h5>
            <h5>Cycling</h5>
            <div className='app__pricing-button'><button><span>Start now</span></button></div>
        </div>
        <div className='app__pricing-card'>
